...
public class KlassendiagrammPMTPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "KlassendiagrammPMT";
	...
	private KlassendiagrammPMTPersistentManager() throws PersistentException {
	...
	protected void configureMetadataSources(MetadataSources aMetadataSources) {
		...
		aMetadataSources.addAnnotatedClass(de.hhn.ai.sportwellbeing.Person.class);
		aMetadataSources.addAnnotatedClass(de.hhn.ai.sportwellbeing.Event.class);
		aMetadataSources.addAnnotatedClass(de.hhn.ai.sportwellbeing.Animator.class);
		aMetadataSources.addAnnotatedClass(de.hhn.ai.sportwellbeing.EventProvider.class);
		aMetadataSources.addAnnotatedClass(de.hhn.ai.sportwellbeing.Visitor.class);
		aMetadataSources.addAnnotatedClass(de.hhn.ai.sportwellbeing.Place.class);
	}
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new KlassendiagrammPMTPersistentManager();
		}
